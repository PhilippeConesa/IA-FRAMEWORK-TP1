...
if __name__=='__main__':
  ...
  parser.add_argument('--learning_rate', type=float,default=float(1e-3),help='learning rate')
  parser.add_argument('--epochs', type=int,default=int(10),help='number_training_epochs')
